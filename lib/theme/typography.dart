...
const kExtraSmallHeavy = TextStyle(
    fontSize: 8 + modifier, fontWeight: FontWeight.w700);
...
const kTinyHeavy = TextStyle(
    fontSize: 10 + modifier, fontWeight: FontWeight.w700);
...
const kLargeHeavy = TextStyle(
    fontSize: 16 + modifier, fontWeight: FontWeight.w700);
// 18
...
const k18Heavy =
    TextStyle(fontSize: 18 + modifier, fontWeight: FontWeight.w700);
...
const kHugeHeavy = TextStyle(
    fontSize: 20 + modifier, fontWeight: FontWeight.w700);
...
const kGiantHeavy = TextStyle(
    fontSize: 24 + modifier, fontWeight: FontWeight.w700);
